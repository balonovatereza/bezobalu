...
public class FiltrPController {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) {
		...
		// mesto uz bylo osetreno v predchozim kontrolu FiltrK a pokud neni zadane, je jednicka
		int idMesta = Integer.parseInt(request.getParameter("idMesta"));
		// kategorie je osetrena uz v predchozi kontroleru ZobrazK a pokud neni zadana, je jednicka
